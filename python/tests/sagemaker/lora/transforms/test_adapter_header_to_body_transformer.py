...
class TestAdapterHeaderToBodyApiTransform:
    ...
    @pytest.mark.asyncio
    @patch('model_hosting_container_standards.sagemaker.lora.transforms.adapter_header_to_body.AdapterHeaderToBodyApiTransform._transform_request')
    ...
    @pytest.mark.asyncio
    @patch('model_hosting_container_standards.sagemaker.lora.transforms.adapter_header_to_body.logger')
    @patch('model_hosting_container_standards.sagemaker.lora.transforms.adapter_header_to_body.AdapterHeaderToBodyApiTransform._transform_request')
    async def test_transform_request_with_key_overwrite_warning(self, mock_transform, mock_logger):
    ...
    async def test_integration_request_transformation(self):
        ...
        with patch('model_hosting_container_standards.sagemaker.lora.transforms.adapter_header_to_body.AdapterHeaderToBodyApiTransform._transform_request') as mock_transform:
            mock_transform.return_value = {
            ...
            # Call method
            result = await transformer.transform_request(mock_raw_request)
